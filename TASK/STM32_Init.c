...
#define __RCC_CR_VAL               0x01090083
#define __RCC_CFGR_VAL             0x051DC002
...
// <e0> 系统时基时钟配置 System Timer Configuration
...
#define __RTC_CLKSRC_VAL          0x00000200
...
#define __TIMER_USED              0x0008                  //  1
#define __TIMER_DETAILS           0x0005                  //  2
#define __TIMER_INTERRUPTS        0x000C                  //  3
#define __TIM1_PERIOD             0xF4240                 //  4
#define __TIM1_PSC                0x0000                  //  5
#define __TIM1_ARR                0xFFFF                  //  6
#define __TIM1_RCR                0x0000                  //  7
#define __TIM1_CR1                0x0004                  //  8
#define __TIM1_CR2                0x1400                  //  9
#define __TIM1_SMCR               0x0000                  // 10
#define __TIM1_CCMR1              0xE061                  // 11
#define __TIM1_CCMR2              0x00B8                  // 12
...
#define __TIM3_PSC                0x0002                  // 35
#define __TIM3_ARR                0xFFFF                  // 36
#define __TIM3_CR1                0x0000                  // 37
#define __TIM3_CR2                0x0080                  // 38
#define __TIM3_SMCR               0x0000                  // 39
#define __TIM3_CCMR1              0x0000                  // 40
#define __TIM3_CCMR2              0x0080                  // 41
#define __TIM3_CCER               0x0100                  // 42
#define __TIM3_CCR1               0x0000                  // 43
#define __TIM3_CCR2               0x0000                  // 44
#define __TIM3_CCR3               0x0014                  // 45
#define __TIM3_CCR4               0x0000                  // 46
#define __TIM3_DIER               0x0008                  // 47
#define __TIM4_PERIOD             0x0FFFF                 // 48
#define __TIM4_PSC                0x0000                  // 49
#define __TIM4_ARR                0x0000                  // 50
#define __TIM4_CR1                0x0080                  // 51
#define __TIM4_CR2                0x0000                  // 52
#define __TIM4_SMCR               0x4077                  // 53
...
#define __USART1_FLOWCTRL         0x00000300
...
#define __USART2_FLOWCTRL         0x00000300
...
// <e0> 通用I/O配置 General purpose I/O Configuration
//--------------------------------------------------------------------------- GPIO port A
...
#define __GPIO_USED               0x5F
#define __GPIOA_CRL               0x4444BBBB
#define __GPIOA_CRH               0x4882BBBB
#define __GPIOB_CRL               0x7B444432
#define __GPIOB_CRH               0x8888BBB2
#define __GPIOC_CRL               0x22222222
#define __GPIOC_CRH               0x22222222
#define __GPIOD_CRL               0x44444444
#define __GPIOD_CRH               0x44444444
#define __GPIOE_CRL               0x36333334
#define __GPIOE_CRH               0x28282828
#define __GPIOF_CRL               0x3300000B
#define __GPIOF_CRH               0x00000033
...
//========================================================= Flexible static memory controller (FSMC) Configuration
// <e0> Flexible static memory controller (FSMC) Configuration
//	<e1.0> Bank 1 NOR/PSRAM 1: Bank 1 NOR/PSRAM 1 enabled (FSMC_BCR1)
//		<o3.19>CBURSTRW: Write burst enable
//			<i>Default: 0:Disenabled Write operations are always performed in asynchronous mode
//		<o3.13>WAITEN: Wait enable
//      	<i>Default: 1:NWAIT signal is enabled
//   	<o3.12>WREN: Write enable
//      	<i>Default: 1:Write operations are enabled
//   	<o3.11>WAITCFG: Wait timing configuration
//      	<i>Default: 0:NWAIT signal is active one data cycle before wait state
//   	<o3.10>WRAPMOD: Wrapped burst mode support
//      	<i>Default: 0: Direct wrapped burst is not enabled
//   	<o3.9>WAITPOL: Wait signal polarity
//      	<i>Default: 0: NWAIT active low
//   	<o3.8>BURSTEN: Burst enable
//      	<i>Default: 0: Burst access mode disabled
//   	<o3.6>FACCEN: Flash access enable
//      	<i>Default: 1:Corresponding NOR Flash memory access is enabled
//		<o3.4..5>MWID: Memory databus width
//				<0=> 8 bits
//				<1=> 16 bits 
//      	<i>Default: 01: 16 bits
//     
//		<o3.2..3>MTYP: Memory type
//			<i>Defulat: 10: NOR Flash
//             <0=> SRAM, ROM
//             <1=> PSRAM,(Cellular RAM: CRAM)
//             <2=> NOR Flash
//		<o3.1>MUXEN: Address/data multiplexing enable
//      	<i>Default: Address/Data multiplexed on databus
//			<e2.0>EXTMOD: Extended mode enable
//				<i>Default: 0: Values inside FSMC_BWTR register are not taken into account
//				<h>Configure read accesses (FSMC_BTR1)
//					<o4.28..29>ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=>access mode A
//							<1=>access mode B
//							<2=>access mode C
//							<3=>access mode D
//					<o4.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o4.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o4.16..19>BUSTURN: Bus turnaround phase duration(0-15)	<0-15> 							
//						<i>Default: 15:BUSTURN phase duration = 16×HCLK clock cycles
//					<o4.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o4.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o4.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//				<h>Configure write accesses (FSMC_BWTR1)
//					<o5.28..29> ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=> access mode A
//							<1=> access mode B
//							<2=> access mode C
//							<3=> access mode D
//					<o5.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o5.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o5.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o5.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o5.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//			</e>
//	</e>
//=============================================================
//  <e1.1> Bank 1 NOR/PSRAM 2: Bank 1 NOR/PSRAM 2 enabled (FSMC_BCR2)
//		<o6.19>CBURSTRW: Write burst enable
//			<i>Default: 0:Disenabled Write operations are always performed in asynchronous mode
//		<o6.13>WAITEN: Wait enable
//      	<i>Default: 1:NWAIT signal is enabled
//   	<o6.12>WREN: Write enable
//      	<i>Default: 1:Write operations are enabled
//   	<o6.11>WAITCFG: Wait timing configuration
//      	<i>Default: 0:NWAIT signal is active one data cycle before wait state
//   	<o6.10>WRAPMOD: Wrapped burst mode support
//      	<i>Default: 0: Direct wrapped burst is not enabled
//   	<o6.9>WAITPOL: Wait signal polarity
//      	<i>Default: 0: NWAIT active low
//   	<o6.8>BURSTEN: Burst enable
//      	<i>Default: 0: Burst access mode disabled
//   	<o6.6>FACCEN: Flash access enable
//      	<i>Default: 1:Corresponding NOR Flash memory access is enabled
//		<o6.4..5>MWID: Memory databus width
//				<0=> 8 bits
//				<1=> 16 bits 
//      	<i>Default: 01: 16 bits
//     
//		<o6.2..3>MTYP: Memory type
//			<i>Defulat: 00: SRAM, ROM
//             <0=> SRAM, ROM
//             <1=> PSRAM,(Cellular RAM: CRAM)
//             <2=> NOR Flash
//		<o6.1>MUXEN: Address/data multiplexing enable
//      	<i>Default: Address/Data multiplexed on databus
//			<e2.0>EXTMOD: Extended mode enable
//				<i>Default: 0: Values inside FSMC_BWTR register are not taken into account
//				<h>Configure read accesses (FSMC_BTR2)
//					<o7.28..29>ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=>access mode A
//							<1=>access mode B
//							<2=>access mode C
//							<3=>access mode D
//					<o7.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o7.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o7.16..19>BUSTURN: Bus turnaround phase duration(0-15)	<0-15> 							
//						<i>Default: 15:BUSTURN phase duration = 16×HCLK clock cycles
//					<o7.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o7.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o7.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//				<h>Configure write accesses (FSMC_BWTR2)
//					<o8.28..29> ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=> access mode A
//							<1=> access mode B
//							<2=> access mode C
//							<3=> access mode D
//					<o8.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o8.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o8.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o8.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o8.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//			</e>
//	</e>
//=================================================================
//  <e1.2> Bank 1 NOR/PSRAM 3: Bank 1 NOR/PSRAM 3 enabled (FSMC_BCR3)
//		<o9.19>CBURSTRW: Write burst enable
//			<i>Default: 0:Disenabled Write operations are always performed in asynchronous mode
//		<o9.13>WAITEN: Wait enable
//      	<i>Default: 1:NWAIT signal is enabled
//   	<o9.12>WREN: Write enable
//      	<i>Default: 1:Write operations are enabled
//   	<o9.11>WAITCFG: Wait timing configuration
//      	<i>Default: 0:NWAIT signal is active one data cycle before wait state
//   	<o9.10>WRAPMOD: Wrapped burst mode support
//      	<i>Default: 0: Direct wrapped burst is not enabled
//   	<o9.9>WAITPOL: Wait signal polarity
//      	<i>Default: 0: NWAIT active low
//   	<o9.8>BURSTEN: Burst enable
//      	<i>Default: 0: Burst access mode disabled
//   	<o9.6>FACCEN: Flash access enable
//      	<i>Default: 1:Corresponding NOR Flash memory access is enabled
//		<o9.4..5>MWID: Memory databus width
//				<0=> 8 bits
//				<1=> 16 bits 
//      	<i>Default: 01: 16 bits
//     
//		<o9.2..3>MTYP: Memory type
//			<i>Defulat: 00: SRAM, ROM
//             <0=> SRAM, ROM
//             <1=> PSRAM,(Cellular RAM: CRAM)
//             <2=> NOR Flash
//		<o9.1>MUXEN: Address/data multiplexing enable
//      	<i>Default: Address/Data multiplexed on databus
//			<e2.0>EXTMOD: Extended mode enable
//				<i>Default: 0: Values inside FSMC_BWTR register are not taken into account
//				<h>Configure read accesses (FSMC_BTR3)
//					<o10.28..29>ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=>access mode A
//							<1=>access mode B
//							<2=>access mode C
//							<3=>access mode D
//					<o10.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o10.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o10.16..19>BUSTURN: Bus turnaround phase duration(0-15)	<0-15> 							
//						<i>Default: 15:BUSTURN phase duration = 16×HCLK clock cycles
//					<o10.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o10.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o10.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//				<h>Configure write accesses (FSMC_BWTR3)
//					<o11.28..29> ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=> access mode A
//							<1=> access mode B
//							<2=> access mode C
//							<3=> access mode D
//					<o11.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o11.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o11.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o11.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o11.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//			</e>
//	</e>
//======================================================================
//  <e1.3> Bank 1 NOR/PSRAM 4: Bank 1 NOR/PSRAM 4 enabled (FSMC_BCR4)
//		<o12.19>CBURSTRW: Write burst enable
//			<i>Default: 0:Disenabled Write operations are always performed in asynchronous mode
//		<o12.13>WAITEN: Wait enable
//      	<i>Default: 1:NWAIT signal is enabled
//   	<o12.12>WREN: Write enable
//      	<i>Default: 1:Write operations are enabled
//   	<o12.11>WAITCFG: Wait timing configuration
//      	<i>Default: 0:NWAIT signal is active one data cycle before wait state
//   	<o12.10>WRAPMOD: Wrapped burst mode support
//      	<i>Default: 0: Direct wrapped burst is not enabled
//   	<o12.9>WAITPOL: Wait signal polarity
//      	<i>Default: 0: NWAIT active low
//   	<o12.8>BURSTEN: Burst enable
//      	<i>Default: 0: Burst access mode disabled
//   	<o12.6>FACCEN: Flash access enable
//      	<i>Default: 1:Corresponding NOR Flash memory access is enabled
//		<o12.4..5>MWID: Memory databus width
//				<0=> 8 bits
//				<1=> 16 bits 
//      	<i>Default: 01: 16 bits
//     
//		<o12.2..3>MTYP: Memory type
//			<i>Defulat: 00: SRAM, ROM
//             <0=> SRAM, ROM
//             <1=> PSRAM,(Cellular RAM: CRAM)
//             <2=> NOR Flash
//		<o12.1>MUXEN: Address/data multiplexing enable
//      	<i>Default: Address/Data multiplexed on databus
//			<e2.0>EXTMOD: Extended mode enable
//				<i>Default: 0: Values inside FSMC_BWTR register are not taken into account
//				<h>Configure read accesses (FSMC_BTR3)
//					<o13.28..29>ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=>access mode A
//							<1=>access mode B
//							<2=>access mode C
//							<3=>access mode D
//					<o13.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o13.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o13.16..19>BUSTURN: Bus turnaround phase duration(0-15)	<0-15> 							
//						<i>Default: 15:BUSTURN phase duration = 16×HCLK clock cycles
//					<o13.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o13.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o13.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//				<h>Configure write accesses (FSMC_BWTR3)
//					<o14.28..29> ACCMOD: Access mode
//						<i>Default: 00: access mode A
//							<0=> access mode A
//							<1=> access mode B
//							<2=> access mode C
//							<3=> access mode D
//					<o14.24..27>DATLAT: Data latency(for synchronous burst NOR Flash)(0-15)	<0-15>
//						<i>Default: 15: Data latency of 17 CLK clock cycles for first burst access
//					<o14.20..23>CLKDIV: Clock divide ratio (for CLK signal)(1-15)	<1-15>
//						<i>Default: 15: CLK period = 16×HCLK periods
//					<o14.8..15>DATAST: Data-phase duration(1-255)	<1-255>
//						<i>Default: 15:DATAST phase duration = 256×HCLK clock cycles
//					<o14.4..7>ADDHLD: Address-hold phase duration(1-15)	<1-15>
//						<i>Default: 15:ADDHLD phase duration = 16×HCLK clock cycles
//					<o14.0..3>ADDSET: Address setup phase duration(0-15)	<0-15>
//						<i>Default: 15:ADDSET phase duration = 16×HCLK clock cycles
//				</h>
//			</e>
//	</e>
//======================================    
#define __FSMC_SETUP			0				//0
#define __FSMC_USED				0x0008			//1
#define __FSMC_DETAILS		0x0001			//2
#define __FSMC_BCR1				0x00000094		//3
#define __FSMC_BTR1				0x3FFFFF10		//4
#define __FSMC_BWTR1			0x0FFFFFFF		//5
#define __FSMC_BCR2				0x000030d2		//6
#define __FSMC_BTR2				0x0fffffff		//7
#define __FSMC_BWTR2			0x0fffffff		//8
#define __FSMC_BCR3				0x000030d2		//9
#define __FSMC_BTR3				0x0fffffff		//10
#define __FSMC_BWTR3			0x0fffffff		//11
#define __FSMC_BCR4				0x00003080		//12
#define __FSMC_BTR4				0x0FF0FFFF		//13
#define __FSMC_BWTR4			0x011F14F0		//14
...
#if __FSMC_SETUP
/*---------------------------------------------------------------------------
 STM32 embedded FSMC interface setup.
 initializes the FSMC_BCR1..4,FSMC_BTR1..4 and FSMC_BWTR1..4 register
-----------------------------------------------------------------------------*/
__inline static void stm32_FsmcSetup (void){

  RCC->AHBENR |= RCC_AHBPeriph_FSMC;				// enable clock for FSMC	

  if (__FSMC_USED & 0x01) {                	        // FSMC_Bank1_NORSRAM1 used
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM1] = __FSMC_BCR1;					// set BCR regist
  	if (__FSMC_DETAILS & 0x01){
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM1] |= FSMC_ExtendedMode_Enable;	// Extended Mode enable
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM1 + 1] = __FSMC_BTR1;			// set read regist
		FSMC_Bank1E->BWTR[FSMC_Bank1_NORSRAM1] = __FSMC_BWTR1;				// set write regist
	}
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM1] |= (u32)0x00000001;				//BCR_MBKEN_Set
  }

  if (__FSMC_USED & 0x02) {                	        // FSMC_Bank1_NORSRAM2 used
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM2] = __FSMC_BCR2;					// set BCR regist
  	if (__FSMC_DETAILS & 0x02){
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM2] |= FSMC_ExtendedMode_Enable;	// Extended Mode enable
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM2 + 1] = __FSMC_BTR2;			// set read regist
		FSMC_Bank1E->BWTR[FSMC_Bank1_NORSRAM2] = __FSMC_BWTR2;				// set write regist
	}
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM2] |= (u32)0x00000001;				//BCR_MBKEN_Set
  }
  if (__FSMC_USED & 0x04) {                	        // FSMC_Bank1_NORSRAM3 used
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM3] = __FSMC_BCR3;					// set BCR regist
  	if (__FSMC_DETAILS & 0x04){
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM3] |= FSMC_ExtendedMode_Enable;	// Extended Mode enable
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM3 + 1] = __FSMC_BTR3;			// set read regist
		FSMC_Bank1E->BWTR[FSMC_Bank1_NORSRAM3] = __FSMC_BWTR3;				// set write regist
	}
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM3] |= (u32)0x00000001;				//BCR_MBKEN_Set
  }
  if (__FSMC_USED & 0x08) {                	        // FSMC_Bank1_NORSRAM4 used
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM4] = __FSMC_BCR4;					// set BCR regist
  	if (__FSMC_DETAILS & 0x08){
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM4] |= FSMC_ExtendedMode_Enable;	// Extended Mode enable
		FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM4 + 1] = __FSMC_BTR4;			// set read regist
		FSMC_Bank1E->BWTR[FSMC_Bank1_NORSRAM4] = __FSMC_BWTR4;				// set write regist
	}
  	FSMC_Bank1->BTCR[FSMC_Bank1_NORSRAM4] |= (u32)0x00000001;				//BCR_MBKEN_Set
  }
}
#endif
